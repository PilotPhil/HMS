...
#include "../../HMS_DEMO1/COM/UDP/myudp.h"
...
QT_MOC_LITERAL(1, 6, 13), // "sendSocketMsg"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 8), // "QString&"
QT_MOC_LITERAL(4, 30, 3) // "msg"

    },
    "MYUDP\0sendSocketMsg\0\0QString&\0msg"
};
...
void MYUDP::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendSocketMsg((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MYUDP::*)(QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MYUDP::sendSocketMsg)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MYUDP::sendSocketMsg(QString & _t1)
{
