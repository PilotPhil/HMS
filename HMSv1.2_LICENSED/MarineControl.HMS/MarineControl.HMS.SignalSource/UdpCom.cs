...
namespace MarineControl.HMS.Communiction
{
    class UdpCom
    {
        ...
        public delegate void ProcessUDPDataHandler(string serialData);
        public event ProcessUDPDataHandler ProcessUDPDataEvent;
        ...
        public void ReceiveUdp()
        {
            try
            {
                while (RunningFlag)
                {
                    ...
                    if(ProcessUDPDataEvent!=null)
                    {
                        ProcessUDPDataEvent(msg);
                    }
