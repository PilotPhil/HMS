...
namespace test_predict
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            //int len = 524288;
            int len = 524288;
            var sig1 = GetTestData(len);
            var sig2 = GetTestData(len);
            var sig3 = GetTestData(len);
            var sig4 = GetTestData(len);


            sw.Start();

            float[] res = Predict(sig1, sig2, sig3, sig4);
        ...
        public float[] Predict(float[] sig1,float[] sig2,float[] sig3,float[] sig4)
        {
            //获取四段信号的最大长度
